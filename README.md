# [Layouts](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/)

**Layout of landing pages**

## [NarrativeBL](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/NarrativeBI/)
Genre - data processing tool

![alt text](NarrativeBI/examples/example-1.png)
![alt text](NarrativeBI/examples/example-2.png)

## [Real Estate](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/Real-Estate/)
Genre - search for housing

![alt text](Real-Estate/examples/example-1.png)
![alt text](Real-Estate/examples/example-2.png)

## [Tours](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/Tours/)
Genre - travels

![alt text](Tours/examples/example-1.png)
![alt text](Tours/examples/example-2.png)

## [Decbase](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/Decbase/)
Genre - design

![alt text](Decbase/examples/example-1.png)
![alt text](Decbase/examples/example-2.png)

## [SipHome](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/SipHome/)
Genre - smart house

![alt text](SipHome/examples/example-1.png)
![alt text](SipHome/examples/example-2.png)

## [ARShakir](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/ARShakir/)
Genre - data processing company

![alt text](ARShakir/examples/example-1.png)
![alt text](ARShakir/examples/example-2.png)

## [Залог](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/RealEstatePledge/)
...
## [Speeky School](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/SpeakySchool/dist/)
Genre - foreign language School

![alt text](SpeakySchool/examples/example-1.png)
![alt text](SpeakySchool/examples/example-2.png)

## [Furniture Ekabu](https://aleksandr-zero.github.io/Layout-landing_corporate-sites/FurnitureEkabu/dist/)
...
![alt text](Geometrica/examples/example-2.png)